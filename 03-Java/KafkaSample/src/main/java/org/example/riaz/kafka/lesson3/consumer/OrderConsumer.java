package org.example.riaz.kafka.lesson3.consumer;
...
public class OrderConsumer {
    public static void main(String[] args) {
        ...
        try (KafkaConsumer<String, Order> kafkaConsumer = new KafkaConsumer<>(properties)) {
            kafkaConsumer.subscribe(Collections.singletonList("OrderAvroTopic"));
            ConsumerRecords<String, Order> consumerRecords = kafkaConsumer.poll(Duration.ofSeconds(30));
